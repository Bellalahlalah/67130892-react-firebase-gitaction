    ...
    return (
      <div>
        <Navbar bg="primary" variant="white">
          <Container>
            <Navbar.Brand href="#"><div style={{color:'white',fontSize:'25px'}}>ค้นหาเลขไปรษณีย์</div></Navbar.Brand>
            <div style={{color:'white',fontSize:'20px'}}> {"67130892 Nunthawun Karnjanavarong"} </div>
          </Container>
        </Navbar>
        <Container>
